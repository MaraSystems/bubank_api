...
// Source: github.com/MaraSystems/graybank_api/db/sqlc (interfaces: Store)
...
func (m *MockStore) ExecuteTx(arg0 context.Context, arg1 func(*db.Queries) error) error {
	m.ctrl.T.Helper()
...
func (mr *MockStoreMockRecorder) ExecuteTx(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ExecuteTx", reflect.TypeOf((*MockStore)(nil).ExecuteTx), arg0, arg1)
}
